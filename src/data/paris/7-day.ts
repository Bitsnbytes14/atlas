...
export const Paris7Day = createTripDataset(7, {
  cityKey: 'paris',
  destination: {
    id: 'dest-paris',
    name: 'Paris',
  ...
  overview: {
    summary: 'A curated 7-day Paris journey featuring landmark culture, neighborhood walks, and classic bistro evenings.',
