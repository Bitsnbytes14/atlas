...
export const Paris5Day = createTripDataset(5, {
  cityKey: 'paris',
  destination: {
    id: 'dest-paris',
    name: 'Paris',
  ...
  overview: {
    summary: 'A curated 5-day Paris journey featuring landmark culture, neighborhood walks, and classic bistro evenings.',
